        ...
        public ActionResult Index()
        {
            try
            {
                ...
                foreach (BRANCH_MST _branch in _list)
                {
                    ...
                    {
                        _wardMst = db.WARD_MST.Find(_branchMst.WARD_ID);
                    }
                    if (_branchMst.DISTRICT_ID != null)
                    {
                        _districtMst = db.DISTRICT_MST.Find(_branchMst.DISTRICT_ID);
                    }
                    if (_districtMst != null && _wardMst != null)
                    {
